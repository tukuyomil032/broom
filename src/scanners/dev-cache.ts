...
export class DevCacheScanner extends BaseScanner {
	...
	private devTools: DevTool[] = [
		...
		{ name: "Gradle caches", path: paths.devCache.gradle, safeToClean: true },
		{
			...
			path: paths.devCache.maven,
			safeToClean: false,
		},
		{
			name: "CocoaPods cache",
			path: paths.devCache.cocoapods,
			safeToClean: true,
		},
		{
			name: "Carthage cache",
			path: paths.devCache.carthage,
			safeToClean: true,
		},
		{
			name: "Composer cache",
			path: paths.devCache.composer,
			safeToClean: true,
		},
	];
